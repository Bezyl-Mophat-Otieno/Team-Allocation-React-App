...
function App() {
  ...
  const [employees , SetEmployees] = useState(JSON.parse(localStorage.getItem('employeesList'))||[{
    ...
    const handleSelectedTeamOnchange = (event)=>{
      setTeam(event.target.value)
      console.log(event.target.value)
    }

   const handleEmployeeCardClicked = (event)=>{
let transformedArray = employees.map((employee)=>(
...
<Employees
 ...
 handleSelectedTeamOnchange ={handleSelectedTeamOnchange}
